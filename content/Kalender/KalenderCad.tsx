...
export default function Kalender({ terpinjam, onClose }: Kalender__inter) {
    ...
    console.log("terpinjam", DataTerpinjam[0].TanggalPinjam)
...

                    {
                        CreateCalendar.map((tangs, i) => {
                            ...
                            if (obj != undefined) {
                                ...
                                console.log("TANGGAL", obj.TanggalPinjam)
